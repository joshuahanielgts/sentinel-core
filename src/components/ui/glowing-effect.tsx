  ...
  ({
    ...
    return (
      <>
        <div
          className={cn(
            "pointer-events-none absolute -inset-px hidden rounded-[inherit] border opacity-0 transition-opacity duration-300 group-hover/glow:opacity-100",
            variant === "white" && "border-white",
            variant === "default" && "border-[hsl(var(--primary)/0.5)]",
            glow && "opacity-100",
            disabled && "!hidden"
          )}
        />
